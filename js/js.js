...
let a2_arr = ["«Засвіт встали козаченьки»","«Чорна рада»","Захар Беркут до Тугара Вовка","«Господи, гніву пречистого…»","Івана Котляревського"]
...
let n_right_answer_arr = [2,2,1,4,4]
